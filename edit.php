            ...
            <div class="row m-2 mt-5">
                ...
                <form action="" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="gas" class="form-control" value="<?php echo $data['gas']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="suhu_lingkungan">Suhu Lingkungan (°C):</label>
                            <input type="text" name="suhu_lingkungan" class="form-control" value="<?php echo $data['suhu_lingkungan']; ?>" required>
                        </div>
