...
<body>
    <div class="d-flex border-dark fixed-top" style="background: #ffe135;">
    ...
    <div class="container text-center" style="margin-top: 80px;">
        <h1>
            Selamat Datang di Website Monitoring Kadar Gas Dan Suhu Pada Buah Pisang Kepok Menggunakan Sensor MQ-3 Dan
            Sensor DHT-11
        </h1>
        <img src="public/image/pisang kepok.png" width="500px">
    </div>
