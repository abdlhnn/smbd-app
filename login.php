...
<body>
    <div class="d-flex border-dark shadow-sm z-3 position-relative" style="background: #ffe135;">
    ...
    <div class="d-flex z-3 position-relative">
        ...
        <div class="p-2 me-5">
            <div class="alert alert-danger alert-dismissible fade <?= isset($_SESSION["loginError"]) ? 'show' : ''; ?>"
                role="alert">
                Login Gagal!
    ...
    <div class="container-fluid mt-1">
        <div class="row">
            <div class="col-md-12">
                <form action="login-process.php" method="post" style="background: #FBF46D;">
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="footer">
                    <div class="d-flex border-dark shadow-sm" style="background: #ffe135;">
                        <div class="p-2 ms-5 flex-grow-1">
                            <img src="public/image/untan.png" width="30px" class="mx-1 me-md-2">
                            <span>
                                Website Monitoring Kadar Gas Dan Suhu Pada Buah Pisang Kepok
                                Menggunakan Sensor MQ-3 Dan
                                Sensor DHT-11
                            </span>
                        </div>
                    </div>
