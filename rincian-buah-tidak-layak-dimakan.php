...
<head>
    ...
    <title>Dashboard | Rincian Buah Tidak Layak Dimakan</title>
    ...
    <div class="main-content">
        <div class="container scrollarea">
            ...
            <div class="row m-2 mt-5">
                <div class="row mt-5">
                    <div class="col-md-12">
                        <a href="buah-tidak-layak-dimakan.php" class="text-decoration-none">
                        ...
                        <div class="col-md-12 table-responsive text-center">
                            <table class="table table-striped align-middle" id="data_grafik_table">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT data.*, warna_buah.warna AS warna_buah_warna FROM data JOIN warna_buah ON data.warna_buah_id = warna_buah.id  WHERE kelayakan = false && warna = ? ORDER BY created_at DESC";
